...
[[maybe_unused]] uint32_t NNOPBASE_Eye = 0U;
} // namespace
    ...
    aclOpExecutor **executor)
{
    ...
    static NnopbaseDfxId tilingId = {0x60000, "aclnnEyeTiling", false};
    void *nnopExecutor;
    static void *executorSpace = NULL;
    const char *opType = "Eye";
    char inputDesc[] = {1};
    char outputDesc[] = {1};
    char attrDesc[] = {1, 0, 1, 0};
    ...
    *executor = reinterpret_cast<aclOpExecutor *>(nnopExecutor);
    ...
    NNOPBASE_ASSERT_NOTNULL_RETVAL(batchShape);
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddIntArrayAttr(*executor, batchShape, 2));
